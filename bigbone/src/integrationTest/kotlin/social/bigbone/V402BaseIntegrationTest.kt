...
abstract class V402BaseIntegrationTest {
    companion object {
        ...
        private val postgresContainer: GenericContainer<*> = GenericContainer(DockerImageName.parse(POSTGRES_IMAGE_VERSION))
            .withNetwork(network)
        ...
        private val redisContainer: GenericContainer<*> = GenericContainer(DockerImageName.parse(REDIS_IMAGE_VERSION))
            .withNetwork(network)
        ...
        private val elasticContainer: GenericContainer<*> = GenericContainer(DockerImageName.parse(ELASTIC_IMAGE_VERSION))
            .withNetwork(network)
        ...
        private val mastodonSidekiqContainer: GenericContainer<*> = GenericContainer(DockerImageName.parse(MASTODON_IMAGE_VERSION))
            .withNetwork(network)
        ...
        private val mastodonStreamingContainer: GenericContainer<*> = GenericContainer(DockerImageName.parse(MASTODON_IMAGE_VERSION))
            .withNetwork(network)
        ...
        fun beforeAll() {
            ...
            mastodonWebContainer.start()
            mastodonSidekiqContainer.start()
            mastodonStreamingContainer.start()
        }
    }
}
