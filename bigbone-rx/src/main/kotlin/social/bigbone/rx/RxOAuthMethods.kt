...
class RxOAuthMethods(client: MastodonClient) {
    ...
    ): Single<String> = Single.fromCallable { oAuthMethods.getOAuthUrl(clientId, redirectUri, scope, forceLogin, languageCode) }
    ...
    fun getAccessTokenWithClientCredentialsGrant(
        ...
        redirectUri: String,
        scope: Scope? = null
    ): Single<Token> = Single.fromCallable { oAuthMethods.getAccessTokenWithClientCredentialsGrant(clientId, clientSecret, redirectUri, scope).execute() }
    ...
    fun getUserAccessTokenWithPasswordGrant(
        ...
        Single.fromCallable { oAuthMethods.getUserAccessTokenWithPasswordGrant(clientId, clientSecret, redirectUri, username, password, scope).execute() }
